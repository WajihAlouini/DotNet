...
if (isset($_GET['id'])){
    $genreC = new  genreC();
    $result=$genreC->recupergenre($_GET['id']);
            ...
            <div class="row">
               ...
               <div class="col-sm-12">
                  ...
                  <div class="iq-card">
                     ...
                     <form method="POST" action="modifiergen.php" >
                           <div class="row">
                            
                              <div class="col-lg-7">
                                 <div class="row">
                                    <div class="col-12 form-group">
                                        <caption>Modifier genre</caption>
                                       <input type="text" class="form-control" name="nomg" value="<?PHP echo $nomg ?>">
                                    </div>
