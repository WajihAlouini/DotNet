               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     ...
                     <ul id="movie" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="active"><a href="type-list.php"><i class="las la-eye"></i>type List</a></li>
                     </ul>
                  </li>
                  <li>
                  ...
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        ...
                        <?php
                            ...
                            $writer1C=new typeC();
                            $listemovie=$writer1C-> Affichertypes();
                                    ...
                                    <td>
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body text-white text-left ml-3">
                                             <p class="mb-0"><?PHP echo $row['nomt']; ?></p>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="modifiertypek.php?id=<?PHP echo $row['id']; ?>"><i class="ri-pencil-line"></i></a>



                                             <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Delete" href="#" onclick="submitForm()">
    <i class="ri-delete-bin-line"></i>
    <form id="deleteForm<?php echo $row['id']; ?>" method="POST" action="supptype.php">
...
<script>
function submitForm() {
    document.getElementById('deleteForm<?php echo $row['id']; ?>').submit();
}
</script>
