   ...
   <div class="wrapper">
      ...
      <div id="content-page" class="content-page">
        ...
        if (isset($_POST['asc'])) {
         ...
         $listemovie = $movie1C->afficherASC();
     } elseif (isset($_POST['desc'])) {
         // Retrieve the products in descending order
         $listemovie = $movie1C->afficherDESC();
     } else {
...
?>
                              <tbody>
                                 <tr>
                                    ...
                                    <td>
                                       <p><?PHP echo $row['DescF']; ?>
                                       </p>
                                    </td>
                                    <td>
                                       <p><?PHP echo $row['trailer']; ?>
                                       </p>
                                    </td>
                                    <td>
                                       <p><?PHP echo $row['UrlF']; ?>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="moviesupd.php?id=<?PHP echo $row['id']; ?>"><i class="ri-pencil-line"></i></a>
...
?>
                           ...
                           <script>
// Add an event listener to the search input field to trigger search on keyup
...
function searchMovie() {
    ...
    // Make an AJAX request to search for movies with the input query
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            // Update the movie table with the searched movie results
            document.getElementById('movie-table').innerHTML = this.responseText;
        }
    };
    xhttp.open("GET", "search_movie.php?q=" + searchQuery, true);
    xhttp.send();
