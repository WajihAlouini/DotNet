...
<style>
    ...
    <script>
        function validateFormg() {
            var nomg = document.forms["myForm"]["nomg"].value;
        ...
        while (errorMessages.length > 0) {
            ...
            document.getElementsByName("nomg")[0].parentNode.appendChild(errorMessage);
        }
        if (nomg == "" ) {
            return false;
        }
             ...
             <div class="row">
                <div class="col-sm-12">
                   <div class="iq-card">
                      ...
                      <form method="POST" action="ajoutgenre.php" enctype="multipart/form-data" name="myForm" onsubmit="return validateFormg()">
                            <div class="row">
                               <div class="col-lg-7">   
                                  <div class="row">
                                     <div class="col-12 form-group">
                                        <input type="text" class="form-control" placeholder="Name" name="nomg">
                                     </div>
