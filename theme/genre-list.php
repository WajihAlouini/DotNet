                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">genre Lists</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="add-genre.php" class="btn btn-primary">Add genre</a>
                        </div>
                     </div>
                     ...
                     <?php
                        ...
                        $movie1C=new genreC();
                        $listemovie=$movie1C-> Affichergenre();
                                    ...
                                    <td>
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body text-white text-left ml-3">
                                             <p class="mb-0"><?PHP echo $row['nomg']; ?></p>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="modifiergenre.php?id=<?PHP echo $row['id']; ?>"><i class="ri-pencil-line"></i></a>
                                            
                                             <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Delete" href="#" onclick="submitForm()">
    <i class="ri-delete-bin-line"></i>
    <form id="deleteForm_<?php echo $row['id']; ?>" method="POST" action="supprimergenre.php">
