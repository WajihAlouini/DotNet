                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="modifieractor.php?id=<?PHP echo $row['id']; ?>"><i class="ri-pencil-line"></i></a>
                                          
                                             
                                             
                                             <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Delete" href="#" onclick="submitForm()">
    <i class="ri-delete-bin-line"></i>
    <form id="deleteForm_<?php echo $row['id']; ?>" method="POST" action="supprimeract.php">
