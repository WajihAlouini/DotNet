                  ...
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        ...
                        <?php
                            ...
                            $writer1C=new writerC();
                            $listemovie=$writer1C-> AfficherWriters();
    ...
    ?>
                                 ...
                                 <tr>
                                    <td>
                                       <div class="media align-items-center">
                                          <div class="iq-movie">
                                             <a href="javascript:void(0);"><img src="uploads/<?php echo $row['img'];?>"
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          ...
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="modifierwriterk.php?id=<?PHP echo $row['id']; ?>"><i class="ri-pencil-line"></i></a>



                                             <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="Delete" href="#" onclick="submitForm()">
    <i class="ri-delete-bin-line"></i>
    <form id="deleteForm<?php echo $row['id']; ?>" method="POST" action="suppwriter.php">
