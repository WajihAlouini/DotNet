...
<body>
    ...
    <?PHP
include "./entites/movie.php";
include "./core/MovieC.php";

$movie1C=new MovieC();
$listemovie=$movie1C-> Afficheractors();
$listegenre=$movie1C-> Affichergenre();
...
if (isset($_GET['id']) and isset($_GET['genre_id'])){
    $MovieC = new MovieC();
    $result=$MovieC->recupermovie($_GET['id']);
    $liste = $MovieC->recuperMoviesBygenre($_GET['genre_id']);
...
?>
                    ...
                    <div class="gen-single-movie-wrapper style-1">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/<?PHP echo $UrlF ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                                <div class="gen-single-movie-info">
                                    <h2 class="gen-title"><?PHP echo $nom ?></h2>
  ...
  <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 5 ,<?php echo $row['genre_id']; ?>)" data-value="5" class="star">&#9733;</a>
  <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 4,<?php echo $row['genre_id']; ?>)" data-value="4" class="star">&#9733;</a>
  <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 3,<?php echo $row['genre_id']; ?>)" data-value="3" class="star">&#9733;</a>
  <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 2,<?php echo $row['genre_id']; ?>)" data-value="2" class="star">&#9733;</a>
  <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 1,<?php echo $row['genre_id']; ?>)" data-value="1" class="star">&#9733;</a>
</div>
...
function submitRating(movieId, rating ,genreId) {
  var savedRating = localStorage.getItem("rating_<?php echo $row['id']; ?>");
  if (savedRating) {
    return;
  }
  ...
  var url = "submit.php?id=" + movieId + "&genre_id=" + genreId + "&rating=" + rating;
  var stars = document.querySelectorAll('.rating-widget a.star');
  stars.forEach(function(star) {
...
<li>
                                                    ...
                                                    <button id="myButton">Trailer</button>

<div id="myPopup" class="popup">
    <div class="popup-content">
        <span class="close">&times;</span>
        <iframe id="videoFrame" width="500" height="400" src="https://www.youtube.com/embed/<?php echo $trailer ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
</div>

<script>
    var originalSrc = document.getElementById("videoFrame").src; // Store the original video src

    // JavaScript code to show and hide the popup
    document.getElementById("myButton").addEventListener("click", function() {
        document.getElementById("myPopup").style.display = "block";
        document.getElementById("videoFrame").src = originalSrc; // Set the src back to the original URL
    });
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6">
                                                <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                                    <div class="gen-movie-contain">
                                                        ...
                                                        <img src="../admin/theme/uploads/<?PHP echo $imgs ?>" alt="streamlab-image">
                                                        ...
                                                        <div class="gen-info-contain">
                                                            ...
                                                            <h3><a href="single-movie.php?id=<?PHP echo $id?>&genre_id=<?PHP echo $genre?>; ?>"><?PHP echo $nom?></a></h3>
                                                            </div>
                                                            <div class="gen-movie-meta-holder">
                                                                <ul>
                                                                    <li><?PHP echo $duree ?> mins</li>
                                                                    <li>
                                                                        <a href="action.html"><span><?PHP echo $genre_id ?></span></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
