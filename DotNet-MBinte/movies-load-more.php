                        ...
                        <div class="gen-carousel-movies-style-3 movie-grid style-3">
                            <div class="gen-movie-contain" style="width: 450px">
                                <div class="gen-movie-img">
                                    <img src="../DotNet-MB_ADMIN/theme/uploads/<?php echo $row['imgs'];?>" alt="streamlab-image"> 
                                ...
                                <div class="gen-info-contain">
                                    ...
                                    <h3><a href="single-movie.php?id=<?php echo $row['id']; ?>&genre_id=<?php echo $row['genre_id']; ?>"><?php echo $row['nom']; ?></a></h3>

                                    </div>
                                    <div class="gen-movie-meta-holder">
                                        <ul>
                                            <li><?PHP echo $row['genre_name']; ?></li>
                                            <li>
