...
<?php
include_once("C:/xampp/htdocs/DotNet-integrationEyaGofWajSal/DotNet-MBinte/configiptv.php");
include_once 'C:/xampp/htdocs/DotNet-integrationEyaGofWajSal/DotNet-MBinte/core/categoryC.php';
include_once 'C:/xampp/htdocs/DotNet-integrationEyaGofWajSal/DotNet-MBinte/core/iptv_channelC.php';


$ss=new  categoryC();
$pr=$ss->affichercategory();


$categoryC=new  channelC();
$prod=$categoryC->afficheriptv_channelparcategory($_GET['id']);
...
?>
                                          <li class="menu-item">
                                             <a href="Afficherchanel.php?id=<?php echo $caa['id_category'] ; ?>"><?php echo $caa['nom_category'] ?></a>
                                          </li>
                                          <?php } ?>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="gen-breadcrumb-container">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">IPTV</li>
                            </ol>
                        </div>
                    </nav>
                </div>
                                ...
                                <div class="gen-carousel-movies-style-1 movie-grid style-1">
                                    <div class="gen-movie-contain">
                                        <div class="gen-movie-img">
                                             ...
                                             <?php echo"<img src='../DotNet-MB_ADMIN/theme/uploads/".$pro['image']."'>" ?>
...
<script type="text/javascript">
    ...
    <button type="submit" class="btn btn-link" onclick="refreshPage(event)">Rating</button>
