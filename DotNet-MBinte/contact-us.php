        ...
        <div class="container container-2">
            <div class="row">
                <div class="col-xl-6">
                    ...
                    <form action="send.php" method="post">
                        <div class="row gt-form">
                            <div class="col-md-6 mb-4"><input type="text" name="idrec" id="idrec" placeholder="id Reclamation">
                            </div>
                            <div class="col-md-6 mb-4"><input type="text" name="numrec" id="numrec" placeholder="num de Reclamation"></div>
                            <div class="col-md-6 mb-4"><input type="text" name="titre" id="titre"
                                    placeholder="titre de Reclamation">
                            </div>
                            <div class="col-md-12 mb-4"><textarea name="description" id="description" rows="6"
                                    placeholder="description"></textarea><br>
                                    <div class="col-md-6 mb-4"><input type="text" name="iduser" id="iduser" placeholder="id user">
                ...
                <div class="rating-widget">
                    <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 5 ,<?php echo $row['rep_id']; ?>)" data-value="5" class="star">&#9733;</a>
                    <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 4,<?php echo $row['rep_id']; ?>)" data-value="4" class="star">&#9733;</a>
                    <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 3,<?php echo $row['rep_id']; ?>)" data-value="3" class="star">&#9733;</a>
                    <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 2,<?php echo $row['rep_id']; ?>)" data-value="2" class="star">&#9733;</a>
                    <a href="#" onclick="submitRating(<?php echo $row['id']; ?>, 1,<?php echo $row['rep_id']; ?>)" data-value="1" class="star">&#9733;</a>
                  </div>
                  ...
                  function submitRating(recId, rating ,repId) {
                    var savedRating = localStorage.getItem("rating_<?php echo $row['id']; ?>");
                    if (savedRating) {
                      return;
                    }
                    ...
                    var url = "submitr.php?id=" + recId + "&rep_id=" + repId + "&rating=" + rating;
                    var stars = document.querySelectorAll('.rating-widget a.star');
                    stars.forEach(function(star) {
