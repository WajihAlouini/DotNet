...
var savedRating = localStorage.getItem("ratings_<?php echo $row['id']; ?>");
if (savedRating) {
...
function submitRating(booksId, rating ,typesId) {
  ...
  var url = "submitb.php?id=" + booksId + "&types_id=" + typesId + "&rating=" + rating;
  var stars = document.querySelectorAll('.rating-widget a.star');
  stars.forEach(function(star) {
  ...
  localStorage.setItem("ratings_<?php echo $row['id']; ?>", rating);
  stars.forEach(function(star) {
