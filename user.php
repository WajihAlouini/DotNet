...
<!-- Mirrored from templates.iqonic.design/streamit/dashboard/html/theme/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 15:49:53 GMT -->
<head>
   <!-- Required meta tags -->
   <meta charset="utf-8">
   ...
   <div class="wrapper">
      ...
      <div class="iq-sidebar">
         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     <a href="rating.html" class="iq-waves-effect"><i class="las la-star-half-alt"></i><span>Rating </span></a>
                  </li>
                  <li>
                     <a href="comment.html" class="iq-waves-effect"><i class="las la-comments"></i><span>Comment</span></a>
                  </li>
         ...
         <div id="content-page" class="content-page">
            ...
            <button type="submit" name="asc" value="ascendant" class="btn btn-danger">^</button>
            <button type="submit" name="desc" value="desandant"class="btn btn-danger">v</button>
            </th>
                                       <th style="width: 10%;">NAME</th>
                                       <th style="width: 10%;">EMAIL</th>
                                       <th style="width: 10%;">AGE</th>
                                       <th style="width: 10%;">id abonnement</th>
                                       <th style="width: 10%;">vod</th>
                                       <th style="width: 10%;">iptv</th>
                                       <th style="width: 10%;">audio_books</th>
                                       <form action="" method="POST">
                                 ...
                                 if(isset($_POST["asc"])){
                                    $sql = "SELECT * FROM accounts JOIN abonnement ON accounts.User_id = abonnement.User_id ORDER BY accounts.User_id ASC" ;
                                 }else if(isset($_POST["desc"])){
                                    $sql = "SELECT * FROM accounts JOIN abonnement ON accounts.User_id = abonnement.User_id ORDER BY accounts.User_id DESC" ;}
                                    else if(isset($_POST["rechercherrr"])){
                                       $sql = "SELECT * FROM accounts JOIN abonnement ON accounts.User_id = abonnement.User_id where accounts.User_id = :id" ;
                                       $sql->bindParam(':id',$_POST['rechercheee']);
                                    
                                    }
                                 else{$sql = "SELECT * FROM accounts JOIN abonnement ON accounts.User_id = abonnement.User_id";}
                                 ...
                                 if (mysqli_num_rows($result) > 0) {
                                     ...
                                     if ($row["audio_books"]=="1"){
                                       echo "<td> yes </td>";
                                         }else{
                                             echo "<td> no </td>";
                                             }?>
                   <td>                            
           <form action="usersup.php" method="POST">
            <input type="submit" value="supprimer">
            <input type="hidden" name="supprim" value = "<?= $row['User_id'] ?>">
            <input type="hidden" name="supprimemail" value = "<?= $row['Email'] ?>">
                                          </form>
                                          </td>
           ...
           <form action="update.php" method="POST">
            ...
            <input type="hidden" name="modif" value = "<?= $row['User_id'] ?>">
                                          </form>
                                          </td>
