...
$prod=$categoryC->afficherchannel();
...
<!-- Mirrored from templates.iqonic.design/streamit/dashboard/html/theme/category-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 15:49:53 GMT -->
<head>
   <!-- Required meta tags -->
   <meta charset="utf-8">
            ...
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active active-menu">
                     <a href="#category" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="true"><i class="las la-list-ul"></i><span>Category</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="category" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="active"><a href="category-list.php"><i class="las la-eye"></i>Category List</a></li>
                     </ul>
                  </li>
                       <li>
                     <a href="#movie" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="las la-film"></i><span>Channel</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <ul id="movie" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="add-channel.php"><i class="las la-user-plus"></i>Add channel</a></li>
                        <li><a href="channel-list.php"><i class="las la-eye"></i>channel List</a></li>
                     </ul>
                  </li>
                  <li>
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="add-channel.php" class="btn btn-primary">Add channel</a>
                            <a href="statchanel.php" class="btn btn-primary">Statistique</a> 
                        </div>
                     </div>
                                 ...
                                 <tr>
                                    ...
                                    <th style="width:20%;">Frame</th>
                                     <th style="width:20%;">image</th>
                                      <th style="width:10%;">id_category</th>
                                    <th style="width:20%;">Raiting</th>
...
?>
                                 ...
                                 <tr>
                                    <td><?php echo $pro['id_channel'] ?></td>
                                    <td><?php echo $pro['nom_channel'] ?></td>
                                     <td><?php echo $pro['url'] ?></td>
                                    <td><?php echo $pro['frame'] ?></td>
      ...
      <style>
            ...
            width: 90px;
                        height: 90px;         
                                    ...
                                    <td><?php echo $pro['raiting'] ?></td>
                                 
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                         
                                          <a class="iq-bg-success" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Edit" href="modifierchann.php?id=<?php echo $pro['id_channel'] ; ?>"><i class="ri-pencil-line"></i></a>
                                          <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                             data-original-title="Delete" href="supprimerchann.php?id=<?php echo $pro['id_channel'] ; ?>"><i
