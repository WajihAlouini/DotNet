               ...
               <div class="col-sm-12">
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        <form action="addchannelfct.php" method="POST" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-lg-7">
                                 <div class="row">
                                    <div class="col-12 form-group">
                                        <input type="hidden" name="id">
                                       <input type="text" class="form-control" placeholder="Nom Channel" name="nom">
                                    </div>
                                    <div class="col-12 form_gallery form-group">
                                       <label id="gallery2" for="form_gallery-upload">Upload Image</label>
                                       <input data-name="#gallery2" id="form_gallery-upload" class="form_gallery-upload"
                                          type="file" accept=".png, .jpg, .jpeg" name="image">
                                    </div>
                                 
                                    <div class="col-sm-6 form-group">
                                       <select class="form-control" id="exampleFormControlSelect2" name="id_cat">
                                        
                                          
                    <?php
foreach($prod as $caa){
?>
       <option value="<?php echo $caa['id_category'] ?>"><?php echo $caa['nom_category'] ?></option>
         <?php } ?>
                                       </select>
                                    </div>
