            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="iq-card">
                     ...
                     <form method="POST" action="addmovie.php" enctype="multipart/form-data" name="myForm" onsubmit="return validateForm()">
                           <div class="row">
                              <div class="col-lg-7">   
                                 <div class="row">
                                    ...
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control" placeholder="Description film " name="DescF">
                                    </div>
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control" placeholder="trailer Link" name="trailer">
                                    </div>
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control" placeholder="Url Film" name="UrlF">
                                    </div>
                                    <div class="col-12 form-group">
...
foreach($listegenre as $row)
{
?>
                                                   <option value="<?PHP echo $row['id']; ?>"><?PHP echo $row['nomg']; ?></option>
...
?>
                                    ...
                                    <div class="col-12 form_gallery form-group">
                                       ...
                                       <input name="imgs" id="form_gallery-upload" class="form_gallery-upload"
