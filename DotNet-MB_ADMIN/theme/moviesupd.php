            ...
            <nav class="iq-sidebar-menu">
               ...
               <li class="active active-menu">
                  ...
                  <ul id="movie" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="add-genre.php"><i class="las la-user-plus"></i>Add Movie</a></li>
                        <li><a href="genre-list.php"><i class="las la-user-plus"></i>Movie list</a></li>
            ...
            <div class="row">
               ...
               <div class="col-sm-12">
                  ...
                  <div class="iq-card">
                     ...
                     <form method="POST" action="moviesup.php" enctype="multipart/form-data" >
                           <div class="row">
                            
                              <div class="col-lg-7">
                                 <div class="row">
                                    <div class="col-12 form-group">
                                        <caption>Edit movies</caption>
                                       <input type="text" class="form-control" name="nom" value="<?PHP echo $nom ?>">
                                    </div>
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control"  name="DescF" value="<?PHP echo $DescF ?>">
                                    </div>
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control"  name="trailer" value="<?PHP echo $trailer ?>">
                                    </div>
                                    <div class="col-12 form-group">
                                       <input type="text" class="form-control"  name="UrlF" value="<?PHP echo $UrlF ?>">
                                    </div>
                                    <div class="col-12 form-group">
                                    ...
                                    <div class="col-12 form-group">
                                       ...
                                       <select class="form-control" name="actor_id" id="id_actor">
                                             <option value="<?PHP echo $actor_id ?>"><?PHP echo $actor_id ?></option>
                                             <?PHP
...
?>
                              ...
                              <div class="col-12 form-group">
                                         ...
                                         <select class="form-control" name="genre_id" id="genre">
                                               <option value="<?PHP echo $genre_id ?>"><?PHP echo $genre_id ?></option>
                                               <?PHP
...
{
?>
                                               <option value="<?PHP echo $rowss['id']; ?>"><?PHP echo $rowss['nomg']; ?></option>
...
?>
                                    ...
                                    <div class="col-12 form_gallery form-group">
                                       ...
                                       <input name="imgs" id="form_gallery-upload" class="form_gallery-upload" value="<?php echo $img; ?>"
                              ...
                              <div class="col-lg-5">
                                 <div class="d-block position-relative" >
                                    ...
                                    <img src="uploads/<?php echo $row['imgs'];?>"   style="width: 55%">
                                    </div>
                                 </div>
                              </div>
