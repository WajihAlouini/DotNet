                     ...
                     <div class="iq-card-header d-flex justify-content-between">
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="add-channel.php" class="btn btn-primary">Add channel</a>
                            <a href="statchanel.php">Statistique</a> 
                        </div>
                     </div>
...
<style>
      ...
      <?php
$pdo = new PDO('mysql:host=localhost;dbname=iptvs', 'root','');
if (!$pdo) {
  echo "error ";
}

$req = $pdo->query("SELECT id_channel,raiting as a from iptv_channel");
