                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Add Writers</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                     <form method="POST" action="crudajoutW.php" enctype="multipart/form-data" name="myForm" onsubmit="return validateForm()">
                           ...
                           <div class="row">
                              <div class="col-lg-7">
                                 <div class="row">
                                    ...
                                    <div class="col-12 form-group">
                                       <input type="Date" class="form-control" placeholder="Birth date"  name="daten">
                                    </div>
                                    <div class="col-12 form_gallery form-group">
                                       <label id="gallery2" for="form_gallery-upload">Upload Image</label>
                                       <input name="img" id="form_gallery-upload" class="form_gallery-upload"
