<?php
    ...
    if(isset($_GET['id']) and isset($_GET['rating']) and isset($_GET['types_id'])) {
        ...
        try {
            ...
            $sqlCheckTable = "SELECT 1 FROM rates LIMIT 1";
            ...
            $sqlCreateTable = "CREATE TABLE rates (
        ...
        $query = "INSERT INTO rates (rating,  book_id,types_id) 
        ...
        header("Location: single-books.php?id=" . $id . "&types_id=" . $types);
