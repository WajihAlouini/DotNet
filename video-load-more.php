...
<body>
    ...
    <!-- breadcrumb -->
    <a      href="crud.php"><i class="fa fa-plus"></i>
    Ajouter Writer</a>
    <!-- Load More -->
                            ...
                            <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                <div class="gen-movie-contain" style="width: 450px" >
                                    <div class="gen-movie-img">
                                        <img src="uploads/<?php echo $row['img'];?>" alt="streamlab-image">
                                    ...
                                    <div class="gen-info-contain">
                                        <div class="gen-movie-info">
                                            <h3><a href="single-movie.html"><?PHP echo $row['nom']; ?></a></h3>
                                        </div>
                                        <div class="gen-movie-meta-holder">
                                            <ul>
                                                <li><?PHP echo $row['prenom']; ?></li>
                                                <li>
                                                    <a href="#"><span><?PHP echo $row['daten']; ?></span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
<form method="POST" action="suppwriter.php">
    <input type="submit" name="supprimer" value="supprimer">
    <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
    </form>


    <a href="modifierwriterk.php?id=<?PHP echo $row['id']; ?>">
    Modifier</a>
</td>
