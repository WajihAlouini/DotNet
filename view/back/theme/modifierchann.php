...
$prod=$channelC->afficheriptv_channel1($_GET['id']);
...
foreach($prod as $pro){
?>
                        <form action="modifierchannelfct.php" method="POST" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-lg-7">
                                 <div class="row">
                                    <div class="col-12 form-group">
                                        <input type="hidden" name="id" value="<?php echo $pro['id_channel'] ?>">
                                       <input type="text" class="form-control" placeholder="Nom Channel" name="nom" value="<?php echo $pro['nom_channel'] ?>">
                                    </div>
                           ...
                           <div class="row">
                              <div class="col-sm-6 form-group">
                                 <input type="text" class="form-control" placeholder="Url" name="url" value="<?php echo $pro['url'] ?>">
                              </div>
                          
                              <div class="col-sm-12 form-group">
                                 <input type="text" class="form-control" placeholder="Frame" name="frame" value="<?php echo $pro['frame'] ?>">
                              </div>
                              <div class="col-12 form-group ">
