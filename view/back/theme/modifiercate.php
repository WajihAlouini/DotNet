...
$prod=$categoryC->affichercategory1($_GET['id']);
...
<!-- Mirrored from templates.iqonic.design/streamit/dashboard/html/theme/add-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Apr 2023 15:49:53 GMT -->
<head>
   <!-- Required meta tags -->
   <meta charset="utf-8">
               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active active-menu">
                     ...
                     <ul id="category" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        <li class="active"><a href="add-category.html"><i class="las la-user-plus"></i>Add Category</a></li>
...
?>
                              <form action="modcatfct.php" method="POST">
                                 <div class="form-group">
                                    <input type="hidden" class="form-control" name="id" value="<?php echo $pro['id_category'] ?>">
                                 </div>
                                 <div class="form-group">
                                    <textarea id="text" name="nom" rows="3" class="form-control"
                                    placeholder="Name"><?php echo $pro['nom_category'] ?></textarea>
                                 </div>
